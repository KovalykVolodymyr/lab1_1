...
public class Product {
    ...
    @Override public boolean equals(Object o) {
        ...
        return Objects.equals(getId(), product.getId()) && Objects.equals(getPrice(), product.getPrice()) && Objects.equals(getName(),
                product.getName()) && Objects.equals(getSnapshotDate(), product.getSnapshotDate()) && Objects.equals(getType(),
                product.getType());
    }

    @Override public int hashCode() {
        return Objects.hash(getId(), getPrice(), getName(), getSnapshotDate(), getType());
    }
}
